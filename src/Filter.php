...
abstract class Filter {
  ...
  public function defaultArgs() {
	...
	$args = [
		...
		'filter' 	 				=> $this->filter(),
		'filter_attributes'	 	=> $this->filterAttributes(),
  ...
  public function setKey( $v ) {
	...
	public function setFilterAttributes( $v ) {
		$this->filterAttributes = $v;
	}
	...
	public function setFilterFieldEl( $v ) {
		$this->filterFieldEl = $v;
	}

	public function filterFieldEl() {
		return $this->filterFieldEl;
	}
